...
class TestAccountOperations:
    ...
    def test_add_account(self, db_module):
        ...
        account = db_module.get_account_by_id(account_id)
    ...
    def test_delete_account_not_in_use(self, db_module):
        ...
        assert result is True
        assert db_module.get_account_by_id(account_id) is None
    ...
    def test_delete_account_in_use_fails(self, db_module):
        ...
        assert result is False
        assert db_module.get_account_by_id(account_id) is not None
